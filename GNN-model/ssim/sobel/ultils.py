...
def single_design_totensor(single_design):
    all_design_input=[]
    add8_dict=txt_to_dictkey("pruning_lib/pre_pruning_add8.txt")
    add12_dict = txt_to_dictkey("pruning_lib/pre_pruning_add12.txt")
    sub10_dict = txt_to_dictkey("pruning_lib/pre_pruning_sub10.txt")
