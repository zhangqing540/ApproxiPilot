...
model=GAT(input_dim, hidden_dim, output_dim,batch_size=batch_size).to(device)
...
for epoch in range(num_epochs):
    ...
    for data in train_loader:
        ...
        optimizer.zero_grad()
        output = model(data)
        new_data = data.y.reshape(batch_size, 1)/2000
    ...
    torch.save(model.state_dict(), "checkpoint/gat_area_sobel_4w.pth")
