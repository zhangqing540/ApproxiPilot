...
class GAT(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, num_heads=8):
        ...
        self.conv2 = GATv2Conv(hidden_dim * num_heads, hidden_dim, heads=num_heads)
        self.conv3 = GATv2Conv(hidden_dim * num_heads, hidden_dim, heads=num_heads)
        self.conv4 = GATv2Conv(hidden_dim * num_heads, hidden_dim, heads=num_heads)
